...
function start() {
  ...
  var allSpecies = document.getElementById("show-all");
  var onlyNative = document.getElementById("show-native");
  var onlyIntroduced = document.getElementById("show-introduced");

  allSpecies.addEventListener("click", function (e) {
    showAll();
  });

  onlyNative.addEventListener("click", showOnlyNative);

  onlyIntroduced.onclick = showOnlyIntroduced;
