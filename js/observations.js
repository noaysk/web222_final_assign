...
function transformObservations(observations) {
  return observations.map(function (observation) {
    var obj = {
      ...
      date:
        "Date " +
        new Date(observation.created_at).toUTCString() +
...
// console.log(transformObservations(arr));
...
function filterObservations(observations) {
  return observations.filter(function (observation) {
    // TODO
    return (
      observation.taxon != undefined &&
      observation.taxon != null &&
      observation.taxon.default_photo != undefined &&
